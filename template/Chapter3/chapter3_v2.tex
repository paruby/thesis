...
This is an instance of linear Independent Component Analysis (ICA), a problem class that will be discussed in detail in Chapter \ref{chapter:ica}.\footnote{\todo{If this chapter gets put after ICA chapter, change this paragraph (and subsequent places in which ICA is mentioned).}}
...
\end{tikzpicture}
%
\caption{Suppose that a complex model $\mathcal{M}_X$ is given but that only the subsystem $X_1,X_2,X_3$ is of interest.
...
For instance, for a pair of distributions, the nearness of the approximation can be defined in multiple ways,\footnote{\todo{if ordering of chapters is moved and divergences have already been introduced, rephrase this.}}
