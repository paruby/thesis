...
Suppose that we are given a dataset of samples that have been drawn \iid~from some unknown data distribution $Q_X$.
...
To make this precise, one must specify a choice of \emph{divergence}
...
We will discuss these questions in the rest of this section. 
