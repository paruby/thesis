...
By placing constraints on the regression function used in such a classifier, it can be shown that the representation obtained by taking an intermediate layer of this classifier recovers $Z$ up to unavoidable ambiguities.
