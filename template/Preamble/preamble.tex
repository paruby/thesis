...
\RequirePackage[backend=biber, style=authoryear, citestyle=authoryear, sorting=nty, natbib=true, maxbibnames=99,maxcitenames=2, dashed=false, uniquelist=false]{biblatex}
